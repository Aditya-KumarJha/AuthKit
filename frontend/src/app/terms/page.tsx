      ...
      <div className="px-10 sm:px-15 py-10 sm:py-12">
        ...
        <section className="space-y-8 leading-relaxed text-base sm:text-lg">
          <div>
            ...
            <p>
              By accessing or using <strong>AuthKit</strong>, you agree to these Terms. 
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>You may not misuse, disrupt, or attempt to gain unauthorized access to the service.</li>
              <li>You may not use AuthKit for spamming, phishing, or distributing malicious software.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              to AuthKit are owned by us or our licensors. You may not copy, 
          ...
          <div>
            ...
            <p>
              ...
              violate these Terms or engage in activity that may harm AuthKit 
              or its users. Upon termination, your right to use the service 
          ...
          <div>
            ...
            <p>
              To the maximum extent permitted by law, AuthKit shall not be held 
          ...
          <div>
            ...
            <p>
              ...
              AuthKit after changes constitutes acceptance of the new Terms.
            </p>
          </div>
